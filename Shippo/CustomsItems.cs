...
namespace Shippo
{
    ...
    public interface ICustomsItems
    {
        ...
        /// </remarks>
        /// </summary>
        Task<CustomsItem> CreateAsync(CustomsItemBase customsItemBase, string? shippoApiVersion = null);
    ...
    public class CustomsItems: ICustomsItems
    {
        ...
        private const string _sdkGenVersion = "2.409.6";
        private const string _openapiDocVersion = "2018-02-08";
        private const string _userAgent = "speakeasy-sdk/csharp 5.0.0-beta.4 2.409.6 2018-02-08 Shippo";
        private string _serverUrl = "";
        private ISpeakeasyHttpClient _client;
        private Func<Shippo.Models.Components.Security>? _securitySource;

        public CustomsItems(ISpeakeasyHttpClient client, Func<Shippo.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
        ...
        public async Task<CustomsItem> CreateAsync(CustomsItemBase customsItemBase, string? shippoApiVersion = null)
        {
            ...
            var serializedBody = RequestBodySerializer.Serialize(request, "CustomsItemBase", "json", false, false);
